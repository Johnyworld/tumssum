...
const KakaoLoginButton: React.FC<KakaoLoginButtonProps> = ({ children, fluid, onClick }) => {
	return (
		<Button className='kakao-login-button' fluid={fluid} onClick={onClick} type='button'>
			<svg className='kakao-login-button__icon' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<span className='kakao-login-button__text'>{children}</span>
		</Button>
	)
}
