...
import { aLotOfNavigationMenu, navigationMenu } from '~/fixtures/common';
...
const TemplateNeverBreak: Story<NavigationMenuProps> = (args) => <NavigationMenu {...args} />
