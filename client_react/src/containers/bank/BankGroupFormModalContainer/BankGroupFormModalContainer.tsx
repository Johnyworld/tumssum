...
const BankGroupFormModalContainer: React.FC<BankGroupFormModalContainerProps> = ({ onClose }) => {
  ...
  return <BankGroupFormModal onSubmit={handleSubmit} isUpdating={isUpdating} onClose={onClose} />;
};
