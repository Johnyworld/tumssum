...
const BankFormModalContainer: React.FC<BankFormModalContainerProps> = ({ onClose }) => {
  ...
  return <BankFormModal groupList={bankGroups} isUpdating={isUpdating} onSubmit={handleSubmit} onClose={onClose} />;
};
