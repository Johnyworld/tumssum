	...
	return (
		!onChangeNumberNegative	
			...
			: <div class='pos-relative fluid'>
					{content}
					<div class='content-editable-number-svg pos-center-y pointer' onClick={handleChangeNumberNegative}>
						{ isNumberNegative
							? <svg width="25" height="16" viewBox="0 0 25 16" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<rect x="8.59973" y="5.00196" width="6" height="1.2" transform="rotate(90 8.59973 5.00196)" fill="var(--color-gray)"/>
							...
							: <svg width="25" height="16" viewBox="0 0 25 16" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<rect x="8.59998" y="5" width="6" height="1.2" transform="rotate(90 8.59998 5)" fill="var(--color-paper)"/>
								</svg>
						}
					</div>
				</div>
